          ...
          <div className="mx-auto max-w-5xl rounded-[2rem] border border-white/10 bg-slate-950/55 p-6 shadow-[0_18px_70px_rgba(15,23,42,0.22)] backdrop-blur-sm sm:p-7">
            ...
            <div className="space-y-5">
              <div className="grid gap-1 md:grid-cols-[280px_1fr]">
                ...
                <p className="text-[14px] leading-relaxed text-slate-300">See signal movement and prep context before you meet, so the session starts with decisions, not recap.</p>
              </div>
              <div className="grid gap-1 md:grid-cols-[280px_1fr]">
                <p className="text-[15px] font-semibold text-white">Between sessions</p>
                <p className="text-[14px] leading-relaxed text-slate-300">Track commitments and risk markers in one place so client momentum does not disappear between calls.</p>
              </div>
              <div className="grid gap-1 md:grid-cols-[280px_1fr]">
                <p className="text-[15px] font-semibold text-white">At day 30</p>
                <p className="text-[14px] leading-relaxed text-slate-300">Use a pass/fail pilot scorecard with two to three live clients before deciding on full rollout.</p>
              </div>
            </div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
              {COACH_BUYER_PLANS.map((plan) => (
                <article key={plan.name} className="rounded-2xl border border-white/10 bg-white/5 p-5 backdrop-blur">
                  ...
                  <p className="text-[13px] leading-relaxed text-slate-300">{plan.fit}</p>
                </article>
              ))}
            </div>
        ...
        <section className="px-4 pb-14 sm:px-6">
          <div className="mx-auto max-w-5xl rounded-[2rem] border border-white/10 bg-slate-950/55 p-6 shadow-[0_18px_70px_rgba(15,23,42,0.22)] backdrop-blur-sm sm:p-7">
            ...
            <div className="mb-4 grid gap-8 md:grid-cols-2 md:divide-x md:divide-slate-200">
              <div>
                <p className="mb-2 text-[12px] font-semibold uppercase tracking-[0.1em] text-slate-400">Platform handles</p>
            ...
            <p className="mb-4 text-[13px] leading-relaxed text-slate-300">Clients control access, can revoke it anytime, and the trust pack explains the permission model in one minute.</p>
