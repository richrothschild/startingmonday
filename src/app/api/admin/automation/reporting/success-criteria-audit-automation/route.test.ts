...
describe('success criteria audit automation route', () => {
  ...
  it('scores success criteria and logs automation run', async () => {
    const response = await POST(new NextRequest('https://startingmonday.app/api/admin/automation/reporting/success-criteria-audit-automation', {
      method: 'POST',
