    ...
    <div className="min-h-screen bg-background font-sans">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-14 sm:py-18">
        <header className="mb-10 max-w-3xl">
          <p className="text-[11px] font-bold tracking-[0.16em] uppercase text-primary mb-3">Research brief</p>
          <h1 className="text-[34px] sm:text-[44px] font-bold text-foreground leading-tight mb-4">A memo-style evidence brief for advisors, investors, and operators.</h1>
        ...
        <section id="executive-summary" className="border border-border rounded-lg bg-muted p-6 mb-10">
          <h2 className="text-[11px] font-bold tracking-[0.12em] uppercase text-muted-foreground mb-3">Executive summary</h2>
          ...
          <ul className="space-y-2 text-[14px] text-muted-foreground leading-relaxed list-disc pl-5">
        ...
        <section id="primary-uses" className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-10">
          <div className="border border-border rounded-lg p-5">
            <h2 className="text-[11px] font-bold tracking-[0.12em] uppercase text-muted-foreground mb-3">Primary uses</h2>
            <p className="text-[13px] text-muted-foreground leading-relaxed mb-3">This brief can be used in investor conversations, partner outreach, coach sales, and external writing.</p>
            <p className="text-[13px] text-muted-foreground leading-relaxed">It should read like an internal research memo, not a marketing asset.</p>
            <p className="text-[13px] text-muted-foreground leading-relaxed mt-2">Outcome metric: shared evidence language shortens alignment cycles across investor and partner reviews.</p>
          </div>
          <div className="border border-border rounded-lg p-5">
            <h2 className="text-[11px] font-bold tracking-[0.12em] uppercase text-muted-foreground mb-3">How to cite it</h2>
            <p className="text-[13px] text-muted-foreground leading-relaxed mb-3">Use it as a synthesis document that points readers to the references page for source-level detail.</p>
            <Link href="/references" className="text-[13px] font-semibold text-foreground underline underline-offset-2 hover:text-primary">Open references {"->"}</Link>
            <p className="text-[12px] text-muted-foreground mt-2">Trust and confidentiality: cite sources directly and avoid sharing private operator details.</p>
          </div>
        </section>

        <section id="print-note" className="border-t border-border pt-8">
          <h2 className="text-[11px] font-bold tracking-[0.12em] uppercase text-muted-foreground mb-3">Print note</h2>
          ...
          <p className="text-[12px] text-muted-foreground leading-relaxed max-w-3xl mt-2">CTA: get started now by sharing this brief with your advisor or investment review group.</p>
        </section>
