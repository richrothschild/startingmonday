  ...
  return (
    <main className="min-h-screen bg-background text-foreground px-4 sm:px-6 py-14 sm:py-20">
      <div className="max-w-4xl mx-auto">
        <p className="text-[11px] font-bold tracking-[0.16em] uppercase text-primary mb-4">Executive channel</p>
        <h1 className="text-[34px] sm:text-[44px] font-bold leading-[1.1] tracking-tight mb-4">
          Run a private, signal-first campaign.
        </h1>
        <p className="text-[16px] text-foreground leading-relaxed max-w-3xl mb-6">
        ...
        <h2 className="text-[16px] font-bold text-foreground mb-6">Search modes</h2>
        <details className="group cursor-pointer mb-4">
          <summary className="flex items-center gap-2 text-[14px] font-semibold text-muted-foreground hover:text-foreground transition-colors">
        ...
        <h2 className="text-[16px] font-bold text-foreground mb-4">Get started</h2>
        <div className="flex flex-wrap gap-3 mb-8">
          <TrackLink
            ...
            className="inline-block bg-muted text-foreground text-[14px] font-semibold px-5 py-3 rounded hover:bg-primary transition-colors"
          >
        ...
        <h2 className="text-[16px] font-bold text-foreground mb-4">Built for your transition</h2>
        <section className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="rounded border border-border bg-background p-4">
            <p className="text-[12px] font-semibold text-foreground mb-2">Built for active transitions</p>
            <p className="text-[13px] text-foreground leading-relaxed">CIO, CTO, CISO, CDO, CPO, COO, and VP-to-C-suite paths with role-level preparation.</p>
          </div>
          <div className="rounded border border-border bg-background p-4">
            <p className="text-[12px] font-semibold text-foreground mb-2">Built for optionality mode</p>
            <p className="text-[13px] text-foreground leading-relaxed">Monitor transition windows and relationship momentum even before you formally announce a move.</p>
          </div>
        </section>
      </div>
