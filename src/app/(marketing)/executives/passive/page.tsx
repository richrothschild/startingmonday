  ...
  return (
    <main className="min-h-screen bg-background text-foreground px-4 sm:px-6 py-14 sm:py-20">
      <div className="max-w-3xl mx-auto">
        <p className="text-[11px] font-bold tracking-[0.16em] uppercase text-primary mb-4">Executive mode: optionality</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
          <div className="rounded border border-border bg-card p-4">
            <p className="text-[12px] font-semibold text-foreground mb-2">Monitoring cadence</p>
            <p className="text-[13px] text-muted-foreground">Weekly signal digest with low-noise alerts for transition windows.</p>
          </div>
          <div className="rounded border border-border bg-card p-4">
            <p className="text-[12px] font-semibold text-foreground mb-2">Primary objective</p>
            <p className="text-[13px] text-muted-foreground">Increase strategic readiness without launching a visible active search.</p>
          </div>
        </div>
