  ...
  return (
    <>
      ...
      >
        ...
        <section className="border border-primary/30 rounded-lg p-5 bg-primary/10">
          <p className="text-[11px] font-bold tracking-[0.12em] uppercase text-primary mb-2">New public edition</p>
        ...
        <section id="pattern-strength" className="border border-border rounded-lg p-5 bg-muted">
          <h2 className="text-[11px] font-bold tracking-[0.12em] uppercase text-muted-foreground mb-3">Observed pattern strength</h2>
          ...
          <p className="text-[12px] text-muted-foreground mt-4">Outcome metric: across pilot observations, pattern-strength indicators clustered in the 84% to 91% range.</p>
        </section>

        <h2 id="observations" className="text-[22px] font-bold text-foreground pt-4">Three observations</h2>
        ...
        <ul className="list-disc pl-5 space-y-2">
          <li><span className="font-semibold text-foreground">Outcome:</span> Executives who act on weak signals earlier create more first-conversation options.</li>
          <li><span className="font-semibold text-foreground">Outcome:</span> Higher prep quality reduces avoidable early-round resets.</li>
          <li><span className="font-semibold text-foreground">Outcome:</span> Coach session time shifts toward strategy when context rebuild is reduced.</li>
        </ul>

        <h2 id="measurement-plan" className="text-[22px] font-bold text-foreground pt-4">What we will keep measuring</h2>
        <p>
        ...
        <section id="next-step" className="border border-border rounded-lg p-5 bg-muted">
          <h2 className="text-[18px] font-bold text-foreground mb-2">Next step</h2>
          ...
          <p className="text-[12px] text-muted-foreground mb-3">CTA: get started now by reviewing the Evidence Hub and applying the measurement model to your own campaign.</p>
