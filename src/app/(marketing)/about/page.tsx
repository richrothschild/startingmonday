...
export default function AboutPage() {
  return (
    <div className="relative min-h-screen overflow-hidden bg-background font-sans text-foreground">
      ...
      {/* Nav */}
      <nav className="bg-background sticky top-0 z-10 border-b border-border">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 h-14 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4 sm:gap-5">
            ...
            <Link
              href="/signup"
              className="text-[13px] font-semibold text-foreground bg-muted px-4 py-1.5 rounded hover:bg-muted/90 transition-colors"
            >
              Try free
            </Link>
          </div>
      ...
      <header className="bg-background px-4 sm:px-6 pt-14 pb-12">
        <div className="max-w-2xl mx-auto">
          <div className="flex items-center gap-5 mb-6">
            <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-full ring-2 ring-border bg-card text-[22px] font-bold text-foreground">
              RR
            </div>
            <div>
              <p className="text-[11px] font-bold tracking-[0.16em] uppercase text-foreground mb-1">
                About
              </p>
              <h1 className="text-[30px] sm:text-[38px] font-bold text-foreground leading-[1.15] tracking-tight">
                Richard Rothschild
              </h1>
            </div>
          </div>
          ...
          <p className="text-[15px] text-foreground leading-relaxed mb-4 max-w-xl">
      ...
      {/* Bio */}
      <article className="px-4 sm:px-6 py-12 sm:py-16 bg-background">
        <div className="max-w-2xl mx-auto space-y-6 text-[15px] text-foreground leading-relaxed">

          <section id="why-me" className="space-y-4">
            <h2 className="text-[17px] font-bold text-foreground">Why me</h2>
          <p>
            <span className="font-semibold text-foreground">Why me:</span> I have spent my career in enterprise
        ...
        <section id="why-product" className="space-y-4">
            <h2 className="text-[17px] font-bold text-foreground">Why this product</h2>
          <p>
            <span className="font-semibold text-foreground">Why this product:</span> I built Starting Monday because
          ...
          <section id="why-now" className="space-y-4">
            <h2 className="text-[17px] font-bold text-foreground">Why now</h2>
          <p>
            <span className="font-semibold text-foreground">Why now:</span> executive hiring moved faster and quieter.
          ...
          <div id="start-where-you-are" className="pt-4 border-t border-border">
            <p className="text-[13px] font-semibold text-foreground mb-3">Start where you are:</p>
            <div className="flex flex-col sm:flex-row gap-3 mb-4">
              <Link
                href="/demo"
                className="text-[13px] font-semibold text-foreground border border-border px-4 py-2 rounded transition-colors"
              >
                Run the live demo
              </Link>
              <Link
                href="/signup"
                className="text-[13px] font-semibold text-primary-foreground bg-primary hover:bg-primary/90 px-4 py-2 rounded transition-colors"
              >
                Start free trial
              </Link>
            </div>
      ...
      {/* Recent writing */}
      <section id="recent-writing" className="bg-background px-4 sm:px-6 py-12 border-t border-border">
        <div className="max-w-2xl mx-auto">
          <p className="text-[11px] font-bold tracking-[0.16em] uppercase text-foreground mb-6">
            Recent writing
          </p>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-0 mb-5 pb-5 border-b border-border">
            ...
            <div className="flex items-center gap-4 sm:gap-5 flex-wrap">
              <Link href="/blog" className="text-[12px] text-muted-foreground hover:text-foreground transition-colors">Blog</Link>
              <Link href="/about" className="text-[12px] text-muted-foreground hover:text-foreground transition-colors">About</Link>
              <a href="https://www.linkedin.com/company/starting-monday" target="_blank" rel="noopener noreferrer" className="text-[12px] text-muted-foreground hover:text-foreground transition-colors">LinkedIn</a>
              <Link href="/privacy" className="text-[12px] text-muted-foreground hover:text-foreground transition-colors">Privacy Policy</Link>
              <Link href="/terms" className="text-[12px] text-muted-foreground hover:text-foreground transition-colors">Terms</Link>
            </div>
          </div>
          <p className="text-[11px] text-foreground">
            &copy; {new Date().getFullYear()} Starting Monday. All rights reserved.
          </p>
          <p className="text-[11px] text-foreground mt-2">Privacy-first by design.</p>
        </div>
      </footer>
