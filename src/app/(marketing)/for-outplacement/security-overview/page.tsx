    ...
    <div className="min-h-screen bg-card font-sans">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-16 sm:py-20">
        <header className="mb-10">
          <p className="text-[11px] font-bold tracking-[0.16em] uppercase text-primary mb-4">Security overview</p>
        ...
        <section className="mb-8 border border-border rounded-2xl p-6 bg-card">
          <p className="text-[11px] font-bold tracking-[0.14em] uppercase text-muted-foreground mb-3">Security principles</p>
        ...
        <section className="mb-8 border border-border rounded-2xl p-6 bg-muted">
          <p className="text-[11px] font-bold tracking-[0.14em] uppercase text-muted-foreground mb-3">What this document includes</p>
          {INCLUDED_TOPICS.map((item) => (
            <p key={item} className="text-[14px] text-muted-foreground leading-relaxed">+ {item}</p>
          ))}
          <p className="text-[11px] font-bold tracking-[0.14em] uppercase text-muted-foreground mb-3 mt-6">What this document intentionally excludes</p>
        ...
        <section className="mb-8 border border-border rounded-2xl p-6 bg-card">
          <p className="text-[11px] font-bold tracking-[0.14em] uppercase text-muted-foreground mb-3">Operating areas</p>
          <div className="space-y-3">
            {OPERATING_AREAS.map((area) => (
              <div key={area.title} className="border border-border rounded-lg p-4 bg-muted">
                <p className="text-[13px] font-semibold text-foreground mb-1">{area.title}</p>
                <p className="text-[13px] text-muted-foreground leading-relaxed">{area.detail}</p>
              </div>
            ))}
          </div>
        </section>
