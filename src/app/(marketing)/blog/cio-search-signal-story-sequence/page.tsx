  ...
  return (
    ...
    >
      ...
      <div className="space-y-6 text-[15px] text-muted-foreground leading-relaxed">
        ...
        <h2 className="text-[22px] font-bold text-foreground pt-4">Signal layer</h2>
        ...
        <h2 className="text-[22px] font-bold text-foreground pt-4">Story layer</h2>
        ...
        <h2 className="text-[22px] font-bold text-foreground pt-4">Sequence layer</h2>
        ...
        <section className="border border-border rounded-lg p-5 bg-muted">
          ...
          <p className="text-[14px] text-muted-foreground leading-relaxed mb-3">See why early transition signals create strategic timing advantage.</p>
