  ...
  return (
    ...
    >
      ...
      <div className="space-y-6 text-[15px] text-muted-foreground leading-relaxed">
        ...
        <h2 className="text-[22px] font-bold text-foreground pt-4">What creates momentum</h2>
        ...
        <h2 className="text-[22px] font-bold text-foreground pt-4">A practical cadence</h2>
