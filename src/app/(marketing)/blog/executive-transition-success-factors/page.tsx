  ...
  return (
    ...
    >
      ...
      <div className="space-y-6 text-[15px] text-muted-foreground leading-relaxed">
        ...
        <h2 className="text-[22px] font-bold text-foreground pt-4">Define success before the search starts</h2>
        ...
        <h2 className="text-[22px] font-bold text-foreground pt-4">Risk factors in the first 90 days</h2>
        ...
        <h2 className="text-[22px] font-bold text-foreground pt-4">Operating model that improves outcomes</h2>
        <ul className="list-disc pl-5 space-y-2">
        ...
        <section className="border border-border rounded-lg p-5 bg-muted">
          <h2 className="text-[18px] font-bold text-foreground mb-2">Evidence and limitations</h2>
          ...
          <Link href="/evidence-hub#transition-success" className="inline-block bg-primary text-primary-foreground text-[13px] font-semibold px-4 py-2 rounded hover:bg-muted transition-colors">
