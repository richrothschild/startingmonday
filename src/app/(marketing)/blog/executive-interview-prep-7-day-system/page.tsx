  ...
  return (
    ...
    >
      ...
      <div className="space-y-6 text-[15px] text-muted-foreground leading-relaxed">
        ...
        <h2 className="text-[22px] font-bold text-foreground pt-4">7-day prep cadence</h2>
        ...
        <h2 className="text-[22px] font-bold text-foreground pt-4">What to validate before the call</h2>
