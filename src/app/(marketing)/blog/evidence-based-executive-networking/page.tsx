  ...
  return (
    ...
    >
      ...
      <div className="space-y-6 text-[15px] text-muted-foreground leading-relaxed">
        ...
        <h2 className="text-[22px] font-bold text-foreground pt-4">Contact-tier model</h2>
        ...
        <h2 className="text-[22px] font-bold text-foreground pt-4">Weekly cadence</h2>
        ...
        <h2 className="text-[22px] font-bold text-foreground pt-4">Message objective by tier</h2>
        <p>
        ...
        <section className="border border-border rounded-lg p-5 bg-muted">
          ...
          <Link href="/evidence-hub#organizational-visibility" className="inline-block bg-primary text-primary-foreground text-[13px] font-semibold px-4 py-2 rounded hover:bg-muted transition-colors">
