  ...
  return (
    ...
    >
      ...
      <div className="space-y-6 text-[15px] text-muted-foreground leading-relaxed">
        ...
        <h2 className="text-[22px] font-bold text-foreground pt-4">What we kept seeing</h2>
        ...
        <h2 className="text-[22px] font-bold text-foreground pt-4">What we built instead</h2>

        <p>
          We designed Starting Monday to support the work between the big moments, because that is where executive searches are won.
        </p>

        <h3 className="text-[18px] font-bold text-foreground pt-2">Signal layer</h3>
        ...
        <h2 className="text-[22px] font-bold text-foreground pt-4">The principle behind the product</h2>
