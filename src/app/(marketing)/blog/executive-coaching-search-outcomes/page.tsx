  ...
  return (
    ...
    >
      ...
      <div className="space-y-6 text-[15px] text-muted-foreground leading-relaxed">
        ...
        <h2 className="text-[22px] font-bold text-foreground pt-4">What to measure</h2>
        ...
        <h2 className="text-[22px] font-bold text-foreground pt-4">Evidence-backed mechanisms</h2>
        ...
        <h2 className="text-[22px] font-bold text-foreground pt-4">How to evaluate coach quality</h2>
        <ul className="list-disc pl-5 space-y-2">
        ...
        <section className="border border-border rounded-lg p-5 bg-muted">
          <h2 className="text-[18px] font-bold text-foreground mb-2">Review full coaching evidence</h2>
          ...
          <Link href="/evidence-hub#coaching-effectiveness" className="inline-block bg-primary text-primary-foreground text-[13px] font-semibold px-4 py-2 rounded hover:bg-muted transition-colors">
