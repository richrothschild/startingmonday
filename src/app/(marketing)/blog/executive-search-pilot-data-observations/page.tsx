  ...
  return (
    ...
    >
      ...
      <div className="space-y-6 text-[15px] text-muted-foreground leading-relaxed">
        ...
        <h2 className="text-[22px] font-bold text-foreground pt-4">What improved</h2>
        ...
        <h2 className="text-[22px] font-bold text-foreground pt-4">Where results varied</h2>
        ...
        <h2 className="text-[22px] font-bold text-foreground pt-4">How to use this data</h2>
        ...
        <section className="border border-border rounded-lg p-5 bg-muted">
          ...
          <p className="text-[14px] text-muted-foreground leading-relaxed mb-3">Review full internal validation details, sample context, and limitations.</p>
          <Link href="/evidence-hub#internal-validation" className="inline-block bg-primary text-primary-foreground text-[13px] font-semibold px-4 py-2 rounded hover:bg-muted transition-colors">Review internal-validation evidence</Link>
        </section>
      </div>
    </BlogPost>
  )
