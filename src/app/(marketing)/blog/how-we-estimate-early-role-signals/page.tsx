  ...
  return (
    ...
    >
      ...
      <div className="space-y-6 text-[15px] text-muted-foreground leading-relaxed">
        ...
        <h2 className="text-[22px] font-bold text-foreground pt-4">What the claim means</h2>
        ...
        <h2 className="text-[22px] font-bold text-foreground pt-4">The timing model</h2>
        ...
        <h2 className="text-[22px] font-bold text-foreground pt-4">Evidence basis</h2>
        ...
        <p>
          ...
          <Link href="/references" className="text-foreground underline hover:text-muted-foreground">references page</Link>.
        </p>

        <h2 className="text-[22px] font-bold text-foreground pt-4">Current limitations</h2>
        ...
        <h2 className="text-[22px] font-bold text-foreground pt-4">How to use this as a candidate</h2>
        ...
        <div className="mt-8 p-5 bg-muted border border-border rounded-lg">
          <p className="text-[14px] font-semibold text-foreground mb-2">See the full signal model inside the platform</p>
          ...
          <Link
            ...
            className="inline-block bg-primary text-primary-foreground text-[13px] font-semibold px-5 py-2.5 rounded hover:bg-primary/90 transition-colors"
          >
        ...
        <p className="mt-8">
          ...
          <Link href="/blog/target-company-list" className="text-foreground underline hover:text-muted-foreground">
            how to build a target-company list
          </Link>
          {' '}and{' '}
          <Link href="/blog/cio-job-market-2026" className="text-foreground underline hover:text-muted-foreground">
