  ...
  return (
    ...
    >
      ...
      <div className="space-y-6 text-[15px] text-muted-foreground leading-relaxed">
        ...
        <h2 className="text-[22px] font-bold text-foreground pt-4">Why messages fail</h2>
        ...
        <h2 className="text-[22px] font-bold text-foreground pt-4">A better structure</h2>
        ...
        <h2 className="text-[22px] font-bold text-foreground pt-4">Follow-up sequence</h2>
        <p>
