        ...
        <header className="dark text-foreground bg-background px-4 sm:px-6 pt-14 pb-12">
          <div className="max-w-2xl mx-auto">
            ...
            <div className="mt-5 rounded-2xl border border-border bg-muted/[0.04] p-4">
              ...
              <p className="text-[13px] leading-relaxed text-foreground">Members evaluate value most intensely during transition windows. Practical operating support outperforms static member benefits in that moment.</p>
            </div>
        ...
        <div className="px-4 sm:px-6 py-12 sm:py-16">
          <div className="max-w-2xl mx-auto space-y-14">
            ...
            <section className="space-y-6">
              <h2 className="text-[22px] font-bold text-foreground">How associations use it</h2>
              <div className="space-y-8">
                {FEATURES.map(f => (
                  <div key={f.name} className="border-l-2 border-primary/30 pl-5">
                    ...
                    <p className="text-[15px] text-muted-foreground leading-relaxed mb-2">{f.forAssociation}</p>
            ...
            <section className="space-y-4 text-[15px] text-muted-foreground leading-relaxed">
              <h2 className="text-[22px] font-bold text-foreground">For your association</h2>
              <p>
            ...
            <section className="bg-muted border border-border rounded-lg p-7">
              ...
              <p className="text-[12px] text-muted-foreground mb-4">CTA: get started now by applying to the partner program.</p>
              <Link
                href="/partners#apply"
