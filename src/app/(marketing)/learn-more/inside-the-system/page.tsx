  ...
  return (
    <LearnMorePageShell backHref="/learn-more">
      <section className="max-w-4xl">
        <p className="text-[11px] font-semibold uppercase tracking-[0.2em] text-primary">In-depth article</p>
        <h1 className="mt-3 font-serif text-[2.2rem] leading-[1.03] tracking-tight text-foreground sm:text-[3rem]">
      ...
      <section className="mt-8 grid gap-5 lg:grid-cols-[0.9fr_1.1fr]">
        <aside className="rounded-2xl border border-border bg-muted/[0.04] p-5 lg:sticky lg:top-24 lg:self-start">
          <p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-primary">What the article covers</p>
          ...
          <div className="mt-5 rounded-2xl border border-primary/20 bg-primary/10 p-4">
            <p className="text-[13px] font-semibold text-foreground">The practical takeaway</p>
        ...
        <div className="space-y-5">
          {SYSTEM_ARTICLE_SECTIONS.map((section) => (
            <article key={section.title} className="rounded-2xl border border-border bg-muted/[0.04] p-5 sm:p-6">
              <h2 className="text-[1.35rem] font-serif leading-tight text-foreground">{section.title}</h2>
              <p className="mt-3 text-[15px] leading-relaxed text-muted-foreground">
                {section.body}
      ...
      <section className="mt-8 rounded-2xl border border-border bg-muted/[0.04] p-5 sm:p-6">
        <p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-primary">What else is different</p>
        <div className="mt-4 grid gap-4 md:grid-cols-2">
          <article className="rounded-2xl border border-border bg-background/45 p-4">
            <p className="text-[14px] font-semibold text-foreground">Executive-grade language</p>
          ...
          <article className="rounded-2xl border border-border bg-background/45 p-4">
            <p className="text-[14px] font-semibold text-foreground">Decision-quality focus</p>
            <p className="mt-2 text-[13px] leading-relaxed text-muted-foreground">
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          ...
          <Link href="/learn-more/common-questions" className="inline-flex items-center rounded-full bg-primary px-4 py-2 text-[13px] font-semibold text-primary-foreground transition-colors hover:bg-primary/90">
