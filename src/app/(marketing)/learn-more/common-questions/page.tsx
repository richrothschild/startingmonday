  ...
  return (
    <LearnMorePageShell backHref="/learn-more">
      <section className="max-w-4xl">
        <p className="text-[11px] font-semibold uppercase tracking-[0.2em] text-primary">Common questions</p>
      ...
      <section className="mt-8 grid gap-4 lg:grid-cols-2">
        {COMMON_QUESTIONS.map((item, index) => (
          <details key={item.question} className="rounded-2xl border border-border bg-muted/[0.04] px-5 py-4">
