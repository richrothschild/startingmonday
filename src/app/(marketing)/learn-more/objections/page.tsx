  ...
  return (
    <LearnMorePageShell backHref="/learn-more">
      <section className="max-w-4xl">
        <p className="text-[11px] font-semibold uppercase tracking-[0.2em] text-primary">Objections</p>
      ...
      <section className="mt-8 space-y-4">
        {OBJECTIONS.map((item, index) => (
          <article key={item.question} className="rounded-2xl border border-border bg-muted/[0.04] p-5 sm:p-6">
            <p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-primary">Objection {index + 1}</p>
            <h2 className="mt-2 text-[1.25rem] font-serif leading-tight text-foreground">{item.question}</h2>
