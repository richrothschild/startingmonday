...
<div className="mb-10">
          <p className="text-[11px] font-bold tracking-[0.16em] uppercase text-primary mb-3">Security and data</p>
          ...
          <p className="text-[15px] text-muted-foreground leading-relaxed max-w-2xl">
            ...
            <a href="mailto:hello@startingmonday.app" className="text-muted-foreground underline">hello@startingmonday.app</a>.
          </p>
        </div>
        ...
        <div className="space-y-10 divide-y divide-border">
          ...
          <section className="pt-10 first:pt-0">
            <h2 className="text-[16px] font-bold text-foreground mb-4">How your data is stored</h2>
          ...
          <section className="pt-10">
            <h2 className="text-[16px] font-bold text-foreground mb-4">Encryption</h2>
            <ul className="space-y-3 text-[14px] text-muted-foreground">
              <li className="flex items-start gap-3">
                <span className="text-muted-foreground shrink-0 mt-0.5 font-bold">+</span>
                <span><strong className="text-foreground">At rest:</strong> AES-256 encryption, provided at the infrastructure level by Supabase and AWS. Every field in your profile, your company notes, and your career history is encrypted on disk.</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-muted-foreground shrink-0 mt-0.5 font-bold">+</span>
                <span><strong className="text-foreground">In transit:</strong> TLS 1.2 or higher on all connections between your browser, our servers, and the database. There is no unencrypted channel.</span>
              </li>
            </ul>
          </section>

          <section className="pt-10">
            <h2 className="text-[16px] font-bold text-foreground mb-4">Who can access your data</h2>
            <p className="text-[14px] text-muted-foreground leading-relaxed mb-3">
          ...
          <section className="pt-10">
            <h2 className="text-[16px] font-bold text-foreground mb-4">AI generation and third parties</h2>
            <p className="text-[14px] text-muted-foreground leading-relaxed mb-3">
          ...
          <section className="pt-10">
            <h2 className="text-[16px] font-bold text-foreground mb-4">Authentication</h2>
            <p className="text-[14px] text-muted-foreground leading-relaxed mb-3">
              Authentication is handled by Supabase Auth, served from{' '}
              <span className="font-mono text-[13px] text-foreground bg-muted px-1.5 py-0.5 rounded">auth.startingmonday.app</span>.
          ...
          <section className="pt-10">
            <h2 className="text-[16px] font-bold text-foreground mb-4">Deleting your data</h2>
            <p className="text-[14px] text-muted-foreground leading-relaxed mb-3">
          ...
          <section className="pt-10">
            <h2 className="text-[16px] font-bold text-foreground mb-4">What we do not do</h2>
            <ul className="space-y-3 text-[14px] text-muted-foreground">
              <li className="flex items-start gap-3">
                <span className="text-muted-foreground shrink-0 mt-0.5 font-bold">+</span>
          ...
          <section className="pt-10">
            <h2 className="text-[16px] font-bold text-foreground mb-4">AI governance and regulatory compliance</h2>
            ...
            <ul className="space-y-4 text-[14px] text-muted-foreground mb-4">
              <li className="flex items-start gap-3">
                <span className="text-muted-foreground shrink-0 mt-0.5 font-bold">+</span>
                <span><strong className="text-foreground">CCPA:</strong> California residents can request access to, correction of, or deletion of all personal data at any time. Use the account deletion option in Settings. We do not sell personal information and have never sold personal information.</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-muted-foreground shrink-0 mt-0.5 font-bold">+</span>
                <span><strong className="text-foreground">EU AI Act:</strong> Starting Monday uses AI to generate career documents - prep briefs, outreach drafts, and strategy summaries. This is an assistive tool that produces draft output for human review. No automated decisions are made about users. All outputs are reviewed and acted on by the user, not by automated systems acting on their behalf.</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-muted-foreground shrink-0 mt-0.5 font-bold">+</span>
                <span><strong className="text-foreground">Enterprise procurement:</strong> If your organization requires AI vendor documentation, a data processing agreement (DPA), or AI usage disclosure for procurement review, contact us at{' '}<a href="mailto:hello@startingmonday.app" className="text-foreground underline">hello@startingmonday.app</a>. We provide these on request.</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-muted-foreground shrink-0 mt-0.5 font-bold">+</span>
                <span><strong className="text-foreground">AI model choice:</strong> We use Anthropic Claude. Anthropic does not use API data to train models under our agreement. We chose Anthropic specifically because of how they handle data and because the model calibrates better to executive-level language than the alternatives.</span>
              </li>
            </ul>
          </section>

          <section className="pt-10">
            <h2 className="text-[16px] font-bold text-foreground mb-4">Incident response</h2>
            <p className="text-[14px] text-muted-foreground leading-relaxed mb-4">
              If we detect unauthorized access to your data, here is what we do and when.
            </p>
            <ul className="space-y-3 text-[14px] text-muted-foreground mb-4">
              <li className="flex items-start gap-3">
                <span className="text-muted-foreground shrink-0 mt-0.5 font-bold">+</span>
            ...
            <p className="text-[14px] text-muted-foreground leading-relaxed">
              ...
              <a href="mailto:hello@startingmonday.app" className="text-foreground underline">hello@startingmonday.app</a>
              {' '}immediately. We respond to all security disclosures within one business day.
            </p>
          </section>

          <section className="pt-10">
            <h2 className="text-[16px] font-bold text-foreground mb-4">Questions</h2>
            <p className="text-[14px] text-muted-foreground leading-relaxed">
        ...
        <div className="mt-12 pt-8 border-t border-border">
          <Link href="/privacy" className="text-[13px] text-muted-foreground underline transition-colors">
            Privacy Policy
          </Link>
          <span className="text-muted-foreground mx-3">|</span>
          <Link href="/" className="text-[13px] text-muted-foreground transition-colors">
