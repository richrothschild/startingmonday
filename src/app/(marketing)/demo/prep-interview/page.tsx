      ...
      <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 sm:py-12 space-y-8">
        ...
        <Card className="border-primary/30 bg-primary/5 p-6 sm:p-8">
          ...
          <div className="pt-4 border-t border-primary/20">
            ...
            <p className="text-[13px] text-primary/80">This prep prevents you from improvising under pressure. You'll walk in confident, with your narrative locked, so you can listen and respond rather than think on your feet.</p>
          </div>
        </Card>
