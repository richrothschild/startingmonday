  ...
  return (
    ...
    >
      <div className="space-y-6 text-[15px] text-muted-foreground leading-relaxed">
        ...
        <h2 id="category-mistake" className="text-[22px] font-bold text-foreground">The category mistake</h2>
        <p>
        ...
        <h2 id="what-we-built" className="text-[22px] font-bold text-foreground pt-2">What we built</h2>
        <p>
        ...
        <h2 id="expected-outcomes" className="text-[22px] font-bold text-foreground pt-2">Expected outcomes</h2>
        <ul className="list-disc pl-5 space-y-2">
          <li><span className="font-semibold text-foreground">Outcome:</span> More strategic first conversations because preparation happens before the call.</li>
          <li><span className="font-semibold text-foreground">Outcome:</span> Less between-session drift because next actions are explicit.</li>
          <li><span className="font-semibold text-foreground">Outcome:</span> Higher coaching leverage because context recovery work is reduced.</li>
        </ul>
        <p>
        ...
        <section id="read-method" className="border border-border rounded-lg p-5 bg-muted">
          <h2 className="text-[18px] font-bold text-foreground mb-2">Read the method behind this note</h2>
          ...
          <p className="text-[12px] text-muted-foreground leading-relaxed mb-3">CTA: get started now by reviewing the Evidence Hub and applying the model to your own campaign.</p>
