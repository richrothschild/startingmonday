      ...
      <main className="mx-auto max-w-6xl px-4 py-8 sm:px-6 sm:py-10">
        ...
        <Card variant="glass" className="mt-5 p-4 sm:p-5">
          ...
          >
            <ToggleGroupItem
              value="all"
              className="whitespace-nowrap rounded-full border border-border px-3 py-1.5 text-[12px] font-semibold text-primary-foreground aria-pressed:border-border aria-pressed:bg-card aria-pressed:text-primary-foreground"
            >
              All personas
            </ToggleGroupItem>
            {(Object.entries(PERSONA_LABELS) as Array<[FeatureDocCard['persona'], string]>).map(([value, label]) => (
              <ToggleGroupItem
                key={value}
                value={value}
                className="whitespace-nowrap rounded-full border border-border px-3 py-1.5 text-[12px] font-semibold text-primary-foreground aria-pressed:border-primary/30 aria-pressed:bg-primary aria-pressed:text-primary-foreground"
              >
                {label}
              </ToggleGroupItem>
            ))}
