        ...
        <section className="bg-white border border-slate-200 rounded p-4 mb-6">
          ...
          <div className="mt-4 pt-4 border-t border-slate-100">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2">
              <a href="https://github.com/richrothschild/startingmonday/tree/main/docs/diagrams" target="_blank" rel="noreferrer" className="rounded-lg border border-slate-300 bg-slate-50 px-3 py-2 text-left hover:border-orange-400 hover:bg-orange-50 transition-colors">
                ...
                <p className="text-[11px] text-orange-500 mt-1">docs/diagrams/ →</p>
              </a>
            </div>
          </div>
        </section>
