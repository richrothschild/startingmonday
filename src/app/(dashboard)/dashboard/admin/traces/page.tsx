    ...
    <div className="min-h-screen bg-slate-100 font-sans">
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className={`mb-4 rounded border px-3 py-2 text-[11px] ${labelingFocusMode ? 'bg-slate-900 text-slate-100 border-slate-800' : 'bg-white text-slate-500 border-slate-200'}`}>
          {labelingFocusMode ? (
            <>
              <span className="font-semibold">Labeling shortcuts:</span> P = pass, F = fail, U = unrated, O = output, J/K = active trace. In this mode, rating auto-advances to the next trace.
            </>
          ) : (
            <>
