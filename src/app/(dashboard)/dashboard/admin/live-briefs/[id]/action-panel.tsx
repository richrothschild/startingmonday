  ...
  return (
    <div className="rounded border border-border bg-card p-5 shadow-sm">
      ...
      <div className="mt-4 flex flex-wrap gap-2">
        ...
        {status === 'ready_for_review' && <button type="button" onClick={() => call(`/api/admin/live-briefs/${requestId}/release`)} disabled={Boolean(working)} className="rounded bg-success px-3 py-2 text-[12px] font-semibold text-success-foreground disabled:opacity-50">{working.includes('/release') ? 'Releasing…' : 'Release private link'}</button>}
