        ...
        <div className="mt-3 flex flex-wrap items-center gap-2">
          ...
          >
            {CHANNEL_OPTIONS.map((option) => (
              <ToggleGroupItem key={option.value} value={option.value} variant="outline" className="text-[12px] font-semibold px-3 py-1.5 h-auto aria-pressed:bg-primary aria-pressed:text-primary-foreground aria-pressed:border-border">
                {option.label}
              </ToggleGroupItem>
            ))}
            <ToggleGroupItem value="coaches:day1" variant="outline" className="text-[12px] font-semibold px-3 py-1.5 h-auto aria-pressed:bg-primary aria-pressed:text-primary-foreground aria-pressed:border-primary/30">
              Day 1 Coach List (60)
            </ToggleGroupItem>
          </ToggleGroup>
          <Button
