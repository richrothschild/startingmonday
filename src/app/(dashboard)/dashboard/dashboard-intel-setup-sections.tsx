...
export function DashboardIntelSetupSections(props: Props) {
  ...
  return (
    <>
      {/* Today */}
      <section id="today" className="bg-white/5 border border-white/15 rounded overflow-hidden mb-8">
      ...
      {/* Warm Paths */}
      {warmPaths.length > 0 && (
        <section id="warm-paths" className="bg-white/5 border border-emerald-300/30 rounded overflow-hidden mb-8">
          <div className="px-6 py-[18px] border-b border-white/10 flex items-center justify-between">
      ...
      {patternAlerts.length > 0 && (
        <section id="pattern-alerts" className="bg-white/5 border border-orange-300/30 rounded overflow-hidden mb-8">
          <div className="px-6 py-[18px] border-b border-white/10 flex items-center justify-between">
      ...
      {/* Signals */}
      {signals.length > 0 && (
        <section id="company-signals" className="bg-white/5 border border-amber-300/30 rounded overflow-hidden mb-8">
          <div className="px-6 py-[18px] border-b border-white/10 flex items-center justify-between">
