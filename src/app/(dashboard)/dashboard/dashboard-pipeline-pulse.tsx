    ...
    <section id="pipeline-pulse" className="bg-white border border-orange-200 rounded overflow-hidden mb-8">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 divide-y sm:divide-y-0 sm:divide-x divide-slate-100">
        <div className="px-6 py-4 text-center">
          ...
          <div className="text-[10px] font-bold tracking-[0.1em] uppercase text-slate-400 mt-1.5">Signal to action</div>
        ...
        <div className="px-6 py-4 text-center">
          ...
          <div className="text-[10px] font-bold tracking-[0.1em] uppercase text-slate-400 mt-1.5">72h SLA</div>
        ...
        <div className="px-6 py-4 text-center">
          ...
          <div className="text-[10px] font-bold tracking-[0.1em] uppercase text-slate-400 mt-1.5">Sponsor coverage</div>
          <div className="text-[11px] text-slate-400 mt-0.5">companies with contacts</div>
        </div>
        <div className="px-6 py-4 text-center">
          <div className={`text-[24px] font-bold leading-none ${decisionLagDays !== null && decisionLagDays >= 7 ? 'text-red-600' : 'text-slate-900'}`}>
            {decisionLagDays ?? 0}d
          </div>
          <div className="text-[10px] font-bold tracking-[0.1em] uppercase text-slate-400 mt-1.5">Decision lag</div>
