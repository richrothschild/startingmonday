      ...
      {!isExecutiveMode && (
        ...
        <div className="grid grid-cols-1 gap-3 lg:grid-cols-3">
          <article className="rounded-xl border border-white/15 bg-white/5 p-5">
            ...
            <Link href="/dashboard/briefing#tenet-find-roles" className="mt-3 inline-flex min-h-[40px] items-center justify-center rounded border border-orange-300/40 bg-orange-500/20 px-3 py-2 text-[12px] font-semibold text-orange-100 hover:text-white">
              Open briefing
            </Link>
          </article>
          <article className="rounded-xl border border-white/15 bg-white/5 p-5">
            ...
            <Link href={canUseOutreachHub ? '/dashboard/outreach' : '/dashboard/contacts'} className="mt-3 inline-flex min-h-[40px] items-center justify-center rounded border border-white/20 px-3 py-2 text-[12px] font-semibold text-slate-100 hover:border-white/35">
              Open relationships
            </Link>
          </article>
          <article className="rounded-xl border border-white/15 bg-white/5 p-5">
            ...
            <Link href="/dashboard/calendar" className="mt-3 inline-flex min-h-[40px] items-center justify-center rounded border border-white/20 px-3 py-2 text-[12px] font-semibold text-slate-100 hover:border-white/35">
              Open plan
            </Link>
          </article>
        </div>
