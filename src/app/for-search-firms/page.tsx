            ...
            <section className="space-y-4 text-[15px] text-slate-700 leading-relaxed">
              ...
              <ul className="space-y-2 pl-4">
                {[
                  ...
                  'Partner program: reach out to Rich Rothschild directly (contact@startingmonday.app) to discuss referral arrangements and preferred partner pricing for your practice',
                ].map((item, i) => (
