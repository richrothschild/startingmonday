    ...
    <header className="mb-14 max-w-3xl">
        ...
        <section className={`mb-12 rounded-lg p-5 sm:p-6 ${premiumEnabled ? 'border border-white/12 bg-slate-950/64 shadow-[0_20px_62px_rgba(15,23,42,0.2)] backdrop-blur-md text-white' : 'border border-slate-200 bg-slate-950 text-white'}`}>
          ...
          <div className="flex flex-wrap gap-3">
            <Link href="/references" className={`inline-block text-[13px] font-semibold px-4 py-2 rounded transition-colors ${premiumEnabled ? 'bg-white text-slate-900 hover:bg-slate-100' : 'bg-white text-slate-900 hover:bg-slate-100'}`}>References â†’</Link>
            <Link href="/evidence-hub" className={`inline-block border text-[13px] font-semibold px-4 py-2 rounded transition-colors ${premiumEnabled ? 'border-white/20 text-slate-100 hover:border-orange-300/60' : 'border-slate-600 text-slate-200 hover:border-slate-400'}`}>Evidence Hub â†’</Link>
            <Link href="/blog/how-we-estimate-early-role-signals" className={`inline-block border text-[13px] font-semibold px-4 py-2 rounded transition-colors ${premiumEnabled ? 'border-white/20 text-slate-100 hover:border-orange-300/60' : 'border-slate-600 text-slate-200 hover:border-slate-400'}`}>Timing model â†’</Link>
          </div>
        </section>
