...
export const BLOG_POSTS: BlogPostMeta[] = [
  ...
  },
  {
    ...
    title: 'We Scanned 600+ Career Pages in Q2 2026. Here Is What CIO Hiring Looks Like Right Now.',
    description: 'Real data from monitoring hundreds of company career pages across technology-intensive sectors. What the CIO job market looks like in Q2 2026, which signals precede a search, and how to monitor career pages before roles appear on LinkedIn.',
    date: '2026-05-10',
    readTime: '7 min read',
    keywords: [
      'CIO job market 2026',
      'CIO hiring trends 2026',
      'how to monitor company career pages',
      'executive job market Q2 2026',
      'CIO job search 2026',
      'technology executive hiring',
      'career page monitoring',
      'CIO opportunities 2026',
    ],
