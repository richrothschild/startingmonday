# Executive Coach Outreach Messages
...
Use one specific signal from their profile or recent post.
...
- Response rate: 15-20%
- Demo to signup: 25-35%

## Internal Notes

- Use this with Sales Navigator coach targeting filters.
- Record outreach by day and outcome in the outreach tracker.
- Route active objections to the outreach playbook appendix for full rebuttals.
