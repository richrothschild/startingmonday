...
| J11 Watchdog + seeding | In Progress | `.github/workflows/monitoring-watchdog.yml`, `.github/workflows/experience-seeding-checklist.yml`, `scripts/experience-seeding-checklist.mjs` | Add probe-account reset automation job and link checklist output into weekly report |
