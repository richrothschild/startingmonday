...
| J10 Weekly Issues + Monthly Trends | In Progress | `scripts/experience-weekly-issues-report.mjs`, `scripts/experience-monthly-trends-report.mjs`, `scripts/trust-weekly-issues-report.mjs`, `scripts/trust-monthly-trends-report.mjs`, `scripts/experience-portfolio-rollup.mjs`, `.github/workflows/experience-portfolio-rollup.yml` | Portfolio rollup now refreshes and normalizes trust/vitals/cognitive/sentinel/journey artifacts; next add stale-source guardrails when any upstream artifact is older than threshold |
